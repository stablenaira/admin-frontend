  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={`border-input data-[placeholder]:text-muted-foreground 
                  ...
                  flex w-full items-center justify-between gap-2 rounded-md border bg-input-background px-3 py-2 
                  text-sm whitespace-nowrap transition-[color,box-shadow] outline-none 
