...
function Sidebar({
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={`bg-red-500 text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col ${className || ""}`}
        {...props}
      >
        {children}
      </div>
...
function SidebarRail({ className, ...props }) {
  ...
  return (
    <button
      ...
      className={`hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={`text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0
...
function SidebarMenuButton({
  ...
  // Get the classes from the variants
  let variantClasses = "";
  if (variant === "default") {
    variantClasses = "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground";
  } else if (variant === "outline") {
    variantClasses = "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]";
  }
  ...
  if (size === "default") {
    ...
    sizeClasses = "h-7 text-xs";
  } else if (size === "lg") {
    sizeClasses = "h-12 text-sm group-data-[collapsible=icon]:p-0!";
  }
...
function SidebarMenuBadge({ className, ...props }) {
  return (
    <div
      ...
      className={`text-sidebar-foreground pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums select-none
